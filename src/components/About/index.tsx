            ...
            <div className="w-full px-4 lg:w-1/2">
              <div className="mb-12 max-w-[540px] lg:mb-0">
                ...
                <p className="mb-10 text-base leading-relaxed text-body-color dark:text-dark-6">
                  ...
                  backgrounds converge to form a powerhouse of creativity,
                  technical prowess, and business acumen. Together, we strive to
                  drive meaningful change through the development and deployment
